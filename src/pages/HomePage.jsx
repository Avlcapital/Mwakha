    ...
    <>
      ...
      <section className="section resource-band">
        <article className="resource-panel resource-panel--primary">
          ...
          <p>
            The document review called for a direct sample action, a browsing
            path, and a downloadable buyer resource. This adds the resource
            layer that was still missing from the site.
          </p>
